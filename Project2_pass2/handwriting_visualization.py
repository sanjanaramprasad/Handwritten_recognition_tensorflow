...
ds = dataset.read_data_sets('C:/Users/srampras/PycharmProjects/Handwriting/', one_hot=True)
...
x = tf.placeholder(tf.float32, shape=[None, 3584],name = 'x')
...
flattened = tf.reshape(conv4 , [-1, 16*14*32])
fc1 = fc_layer(flattened , 14*16*32 ,3000,keep_prob , name = 'fc1' )
#fc2 = fc_layer(fc1 , 1700 , 1000 , keep_prob , name ='fc2')
logits = fc_layer(fc1 , 3000, 2 ,keep_prob , name = 'fc3' , logits= True)
...
writer = tf.summary.FileWriter('C:/Users/srampras/PycharmProjects/Handwriting/tensorflow_logs/train')
validation_writer = tf.summary.FileWriter('C:/Users/srampras/PycharmProjects/Handwriting/tensorflow_logs/validation')
...
for i in range(25):
    ...
    for batch_x,batch_y in ds.validation.next_batch():
        ...
        if step%100 == 0:
            ...
            validation_writer.add_summary(validation_summary , display_step)
