...
class encode_data(luigi.Task):
	...
	def run(self):
		with self.output().open('w') as out_file:
			...
			yield encode(training_dir, 'training-images-and-ubyte_4','training-labels-and-ubyte_4')
			yield encode(testing_dir, 'testing-images-and-ubyte_4','testing-labels-and-ubyte_4')
			#yield encode(testing_dir, 'testing-labels-and-ubyte_20',  label="label")
			yield encode(validation_dir ,'validation-images-and-ubyte_4', 'validation-labels-and_ubyte_4')
