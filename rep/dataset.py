...
def read_data_sets(train_dir,
      ...
      TRAIN_IMAGES = 'training-images-and-ubyte_v2.gz'
      TRAIN_LABELS = 'training-labels-and-ubyte_v2.gz'
      TEST_IMAGES = 'testing-images-and-ubyte_v2.gz'
      TEST_LABELS = 'testing-labels-and-ubyte_v2.gz'
